...
# Bundle vba-devtool with the VS Code extension

The Marketplace extension should bundle a self-contained Windows `vba-devtool.exe`
...
`bin/vba-devtool/win-x64/vba-devtool.exe`; the `tools/vba-devtool` source tree
