...
namespace VbaTools.TestFixtures;
...
{
    internal static byte[] CreateWithoutVbaProject()
        => Create(new PackageMetadataFixtureOptions
        {
            IncludeVbaProjectPart = false,
            ContentTypesXml = CreateContentTypesXml("xl/vbaProject.bin", "application/vnd.ms-office.vbaProject")
                .Replace("<Override PartName=\"/xl/vbaProject.bin\" ContentType=\"application/vnd.ms-office.vbaProject\"/>",
                    string.Empty, StringComparison.Ordinal),
            WorkbookRelationshipsXml = "<Relationships xmlns=\"http://schemas.openxmlformats.org/package/2006/relationships\"/>"
        });
