...
internal sealed record VbaInterfaceVariableAccessorContract(
    ...
    bool IsConditional)
{
    public string Signature => VbaCallableSignaturePresentation.Assemble(
...
internal sealed class VbaInterfaceSemanticModel
{
    ...
    public IReadOnlyList<VbaSemanticDiagnostic> GetDiagnostics(
        VbaSourceDocument implementingDocument)
    {
        var diagnostics = new List<VbaSemanticDiagnostic>();
                 ...
                 }))
        {
            ...
            foreach (var wrongKindMember in wrongKindMembers)
            {
                ...
                diagnostics.Add(new VbaSemanticDiagnostic(
    ...
    private static VbaCallableParameter CreatePresentationParameter(
        ...
        => VbaCallableSignaturePresentation.PresentParameter(new VbaCallableParameter(
            parameter.Name,
