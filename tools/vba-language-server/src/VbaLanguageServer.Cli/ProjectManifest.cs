...
/// <summary>
/// Represents the vba-project.json contract read by the language server for editor features.
/// </summary>
...
/// <summary>
/// Names a VBA project reference declared in vba-project.json.
/// </summary>
/// <param name="Name">The human-visible reference description.</param>
public sealed record VbaProjectReference(string Name);

/// <summary>
/// Stores project-level command defaults mirrored from vba-project.json.
/// </summary>
