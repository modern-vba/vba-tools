...
/// <param name="ProjectNameSpecified">Whether --name was explicitly present.</param>
/// <param name="OutputDirectorySpecified">Whether --output was explicitly present.</param>
