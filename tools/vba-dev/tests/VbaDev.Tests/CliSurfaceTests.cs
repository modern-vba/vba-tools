...
public sealed class CliSurfaceTests
{
    ...
    public async Task CapabilitiesRunThroughPublicCommandLineBoundary()
    {
        ...
        var activeCodePageProperty = OperatingSystem.IsWindows()
            ...
            : string.Empty;
        Assert.Equal(
            "{\"toolVersion\":\"0.1.0\",\"contractVersion\":\"1.0\",\"featureVersions\":{\"build.sourceSnapshot\":\"2.0\",\"build.sourceSnapshotAnalysis\":\"1.0\",\"test.sourceSnapshot\":\"2.0\",\"invocation.stdinCancellation\":\"1.0\",\"sourceSnapshot.activeWindowsCodePage\":\"1.0\",\"projectCreation.pathValidation\":\"1.0\",\"hostEvent.list\":\"1.0\"}," +
